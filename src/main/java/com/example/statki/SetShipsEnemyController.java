...
public class SetShipsEnemyController {
    ...
    public Battlefield battlefieldUser = new Battlefield();
    ...
    public void nextClicked(ActionEvent actionEvent) throws IOException {
        ...
        secondPlayer.setBattlefield(battlefieldUser);
        FXMLLoader loader = new FXMLLoader(getClass().getResource("game.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        GameController GameController = loader.getController();
        GameController.setGame(player, secondPlayer, mainPane);
    ...
    public void setPlayer(Player player, Player secondPlayer) {
        this.player = player;
        this.secondPlayer = secondPlayer;
        nickNameLabel.setText(secondPlayer.nick);
        System.out.println("pierwszy leftPlayer: " + this.player);
        System.out.println("drugi leftPlayer: " + this.secondPlayer);
        if (this.player != null) {
            System.out.println("Przekazany obiekt player o nicku: " + player.getNick());
        }
    }
}